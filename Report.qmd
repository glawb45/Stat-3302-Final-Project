...
plot.afr <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Africa")
```
...
plot.amer <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Americas")
...
plot.asia <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Asia")
```
...
plot.aus_nz <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Australia/NZ")
```
...
plot.car <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Caribbean")
```
...
plot.c_amer <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "C. America")
```
...
plot.e_afr <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title = "E. Africa")
```
...
plot.e_asia <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "E. Asia")
```
...
plot.e_euro <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "E. Europe")
```
...
plot.euro <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm")  + labs(title =  "Europe")
```
...
plot.micro <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Micronesia")
```
...
plot.m_afr <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "M. Africa")
```
...
plot.n_afr <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "N. Africa")
```
...
plot.n_amer <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "N. America")
```
...
plot.oceania <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "Oceania")
```
...
plot.s_amer <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "S. America")
```
...
plot.s_afr <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "S. Africa")
```
...
plot.s_asia <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "S. Asia")
```
...
plot.s_euro <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title =  "S. Europe")
```
...
plot.w_afr <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm")  + labs(title =  "W. Africa")
```
...
plot.w_asia <- merged_data %>%
  ...
  ggplot(aes(x = Year, y = Yield)) + geom_point() + theme_bw() + geom_smooth(method = "glm") + labs(title = "W. Asia")
```
...
Entity*wheat: A one-unit change in wheat produced in Western Africa with respect to wheat produced in Africa corresponds to a 0.709-multiplicative-odds decrease in crop yield.
Entity*rice: A one-unit change in rice produced in the Caribbean with respect to rice produced in Africa corresponds to a 0.9745-multiplicative-odds decrease in crop yield.
Entity*maize: A one-unit change in maize produced in Australia & New Zealand with respect to maize produced in Africa corresponds to a 1.58-multiplicative-odds decrease in crop yield.
Entity*soybeans: A one-unit change in soybeans produced in Asia with respect to soybeans produced in Africa corresponds to a 1.58-multiplicative-odds decrease in crop yield.
Entity*potatoes: A one-unit change in potatoes produced in Oceania with respect to potatoes produced in Africa corresponds to a 0.184-multiplicative-odds decrease in crop yield.
Entity*beans: A one-unit change in beans produced in Australia & New Zealand or Oceania with respect to beans produced in Africa corresponds to a 3.26-multiplicative-odds decrease in crop yield.
Entity*peas: A one-unit change in peas produced in Europe with respect to peas produced in Africa corresponds to a 2.35-multiplicative-odds decrease in crop yield.
Entity*cassava: A one-unit change in cassava produced in Northern Africa with respect to cassava produced in Africa corresponds to a 2.17-multiplicative-odds decrease in crop yield.
Entity*barley: A one-unit change in barley produced in Western Africa with respect to barley produced in Africa corresponds to a 0.81-multiplicative-odds decrease in crop yield.
Entity*cocoa_beans: A one-unit change in cocoa beans produced in Micronesia with respect to cocoa beans produced in Africa corresponds to a 15.56-multiplicative-odds decrease in crop yield.
Entity*bananas: A one-unit change in bananas produced in Europe with respect to bananas produced in Africa corresponds to a 0.198-multiplicative-odds decrease in crop yield.
